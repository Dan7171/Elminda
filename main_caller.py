...
class mainCaller():
    def func(self):
        ...
        #curr_score = models_runner.lr(subject_to_subject_group, X_lr, k_select_k_best=10,y_name='change_HDRS-17')
        X_knn = subjects_X.copy()
        curr_score = models_runner.knn(subject_to_subject_group, X_knn, k_select_k_best = 40,k_knn = 3,y_name ='end_of_treatment_class_HDRS-17')
